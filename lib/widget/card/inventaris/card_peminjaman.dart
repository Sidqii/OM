              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    ...widget.pinjam.inventaris
                        .map((item) => Text(
                            '${item.namaInventaris}', style: subtitleStyle)),
                    SizedBox(height: 6),
                    ...
                    SizedBox(height: 6),
                    Text('Tanggal Peminjaman', style: boldStyle),
                    SizedBox(height: 2),
                    Text(widget.pinjam.tanggalPengembalian, style: subtitleStyle),
                  ],
                ),
              ),
              SizedBox(width: 10),
